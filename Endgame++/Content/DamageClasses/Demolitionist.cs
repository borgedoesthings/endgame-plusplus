...
//10/16/2024: it fucking works, but it has issues

using Terraria;
using Terraria.ModLoader;

namespace Endgameplusplus.Content.DamageClasses
{
    public class Demolitionist : DamageClass
    {
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<Demolitionist>() += 4;
            player.GetArmorPenetration<Demolitionist>() += 10;
